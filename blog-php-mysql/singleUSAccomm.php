...
<?php include(ROOT_PATH . '/app/controllers/usaccomms.php');

if (isset($_GET['id'])) {
    $post = selectOne('usaccomms', ['id' => $_GET['id']]);
}
$states = selectAll('states');
$posts = selectAll('usaccomms', ['published' => 1]);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="section topics">
                    ...
                    <ul>
                        <?php foreach ($states as $state) : ?>
                            <li><a href="<?php echo BASE_URL . '/index.php?p_id=' . $state['id'] . '&name=' . $state['name'] ?>"><?php echo $state['name']; ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            </div>
