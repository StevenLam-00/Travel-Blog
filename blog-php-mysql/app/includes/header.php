<header>
    ...
    <ul class="nav">
      ...
      <li>
        <a href="#"> Accommodations <i class="fa fa-chevron-down" style="font-size: .8em;"></i>
        </a>
        <ul>
          <li><a href="<?php echo BASE_URL . '/vnAccomm.php' ?>">Vietnam</a></li>
          <li><a href="<?php echo BASE_URL . '/usAccomm.php' ?>">United States</a></li>
        </ul>
      </li>
