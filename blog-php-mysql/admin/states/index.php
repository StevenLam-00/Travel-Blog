...
<head>
    ...
    <title>Admin Section - Manage States</title>
</head>
                    ...
                    <tbody>
                        <?php foreach ($states as $key => $state) : ?>
                            <tr>
                                ...
                                <td><a href="edit.php?id=<?php echo $state['id']; ?>" class="edit">edit</a></td>
                                <td><a href="index.php?del_id=<?php echo $state['id']; ?>" class="delete">delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
